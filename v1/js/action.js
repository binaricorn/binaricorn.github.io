var s_dialogue = [
    ...
    {
        scene: {
            script: "<p><span class='ip'></span>, your familiar number spirit, the record of your educational history. Thwarting you.</p><p>This is the directory where Git will be initialized. You remember the command <code>git init</code> and type it into the glowing interface.</p>"
